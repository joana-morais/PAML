...
# Identification of genes  not present in all sequences (presence_absence_gene_matrix.sh)
# This script analyzes FASTA files to identify HOX genes across three reptile species (Calyptommatus, Tretioscincus, and Salvator), creating a presence/absence matrix and highlighting potential naming inconsistencies between species.
